...
**Datos usados en el análisis de las amenazas reportadas en las ANP en el sistema I-Efectividad durante el ciclo 2021**
...
df_amenazas_naturales = df_amenazas_naturales[,c(2,6:23)]
...
df_amenazas_inducidas <- df_amenazas_inducidas[, c(2, 6:31)]  # Seleccionar las columnas
